...
export class HelpView extends DocumentView {
  ...
  ${HelpView.joinTexts(19, [`${c['magit.worktree']} Worktree`, `${c['magit.submodules']} Submodules`, `${c['magit.process-log']} Process Log`, `${c['magit.open-terminal']} Terminal`, c['magit.terminal'] ? `${c['magit.terminal']} Terminal menu` : undefined])}
